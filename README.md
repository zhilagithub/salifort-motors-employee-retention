...
This project analyzes employee data from Salifort Motors to understand factors associated with employee turnover and develop a logistic regression model to predict whether an employee is likely to leave the company.
